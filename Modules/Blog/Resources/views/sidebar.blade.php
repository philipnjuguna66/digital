<div class="side-bar">
    ...
    <div class="widget">
        ...
        <div class="media mb-3 border-bottom pb-3 border-color-extra-light-gray">
            <img class="me-3 border-radius-4" src="{{ asset('img/blog/insta-01.jpg') }}" alt="...">
        ...
        <div class="media mb-3 border-bottom pb-3 border-color-extra-light-gray">
            <img class="me-3 border-radius-4" src="{{ asset('img/blog/insta-02.jpg') }}" alt="...">
            <div class="media-body align-self-center">
        ...
        <div class="media">
            <img class="me-3 border-radius-4" src="{{ asset('img/blog/insta-03.jpg') }}" alt="...">
            <div class="media-body align-self-center">
