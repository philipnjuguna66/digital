<footer class="pt-10 pt-md-4 bg-primary footer-style1 position-relative">
    <div class="container">
       {{-- <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <p class="mb-0 text-white">&copy; {{ now()->format('Y') }} SEO Powered by <a href="#!" class="text-white">Digital Marketing Kenya</a></p>
                    </div>
                </div>
            </div>
        </div>
