<footer class="bg-gray-800 relative p-2" aria-labelledby="footerHeading">
    <h2 id="footerHeading" class="sr-only">Footer</h2>
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
            <div class="">
                <x-jet-application-logo class=" bg-right-top h-16 "/>
            </div>
            <div class="grid grid-cols-2 gap-6 xl:col-span-4">
                    ...
                    <div>
                       ...
                       {{-- <ul class="mt-4 space-y-4">
                            @foreach(\App\Models\Service::get() as $service)
                                ...
                                <li>
                                    <a href="{{route('show.service',$service->slug)}}" class="text-base text-gray-300 hover:text-white">
                                        {{$service->title}}
                                    </a>
                                </li>
